...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-06-2025 a las 02:05:18
...
(6, NULL, 'rafale enriques', '12.3115.678-7', 'Av.  12333333', '+56919988456'),
(7, NULL, 'Lamine YABINEEEEEE', '12.3115.678-7', 'Av.  12333333', '+56919988456'),
(8, NULL, 'Lamine Yamaaaaaaaaal', '21.211.211.5', 'Av los mayas 400', '+56919988456');
...
(5, 'maxidesceutnoen unicamar', 500000, '2025-11-08'),
(6, 'Lider a 1mil', 1000, '2025-11-08'),
(7, 'BalatoMuyBalato', 200, '2026-11-08');
...
(6, 11, 'av franklin', 'en camino', '2025-06-05', '2025-06-16'),
(7, 7, 'vespucio norten', 'Completado', '2025-06-05', '2025-06-06'),
(8, 12, 'Los mayas 40040', 'Completado', '2025-06-05', '2025-06-10');
...
(4, 3, 10, 'Salida', '2025-06-05 12:12:54', 'despacho a casa', '2025-06-05 16:12:54'),
(5, 4, 1, 'Salida', '2025-06-08 14:12:02', 'Delivery al sur de chile', '2025-06-08 18:12:02');
...
(7, 'Mouse Logiteh', 'logitech', 100000, 'Tecnologia', 1),
(8, 'Mouse Logiteh', 'logitech', 100000, 'Tecnologia', 1);
...
INSERT INTO `soporte` (`id_ticket`, `id_usuario`, `tipo_ticket`, `descripcion`, `estado`, `fecha_creacion`, `fecha_resolucion`, `tecnico_id`) VALUES
(3, 8, 'Problema con el producto', 'No enciende el dispositivo', '{\r\n  \"estado\": \"Resuelto\"\r\n}\r\n', '2025-06-08', NULL, 1),
(5, 8, 'Problema con el producto', 'No enciende el dispositivo', '{\r\n  \"estado\": \"Resuelto\"\r\n}\r\n', '2025-06-08', NULL, 1),
(7, 8, 'Consulta técnica', 'No puedo acceder a mi cuenta.', 'Abierto', '2025-06-08', NULL, 1);
...
INSERT INTO `tecnicos` (`id`, `nombre_completo`, `cargo`, `activo`, `fecha_ingreso`, `usuario_id`) VALUES
(1, 'María Fernández', 'Soporte Nivel 1', 1, '2025-06-08', 1);
...
(15, 'Violet', 'admin01@ejemplo.com', '$2a$10$7XDulYX62.XSzhZSczOJY.sxfLTS6qVNw8lrN5mLmIAiyD2Y5tAly', 'admin', 'activo', NULL),
(16, 'ola_12ola', 'Campossss@example.com', '$2a$10$oUKfakDcGDkn/P5Y6yCQoOZZKzuLrU2z1U0Zpa0s8aqnUntzyw6GW', 'ADMIN', 'activo', NULL);
...
(7, 16, 'ana maria perez ARAaaaa', '1234567333855-9', 1),
(8, 12, 'Juan perez perez', '12345678444444-9', 1),
(9, 16, 'Violet Evergarden', '12345678444444-9', 1),
(10, 14, 'Manuel Rodriguez', '12345678444444-9121212121', 1);
